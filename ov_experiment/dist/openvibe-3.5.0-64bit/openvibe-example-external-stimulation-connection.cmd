...
if NOT !STRIPPEDARG! == !EMPTY! (
	...
	IF /i "!STRIPPEDARG!" == "--run-bg" (
		...
		SET OV_RUN_IN_BG=START "openvibe-example-external-stimulation-connection.exe"
		SET OV_PAUSE=
		goto found:
	)
...
%OV_RUN_IN_BG% "%OV_PATH_ROOT%\bin\openvibe-example-external-stimulation-connection.exe"  %ARGS%
